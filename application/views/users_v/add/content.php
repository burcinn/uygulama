          ...
          <div class="col-12">
            ...
            <div class="card card-info">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url("users/save")?>">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="category" class="col-sm-2 col-form-label">Soyadı:</label>
                    <div class="col-sm-10">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="re-pass" id="r-pass" placeholder=" Şifreyi Tekrardan  Giriniz">
                    </div>
                  </div>
                  <?php if(isset($formError)){?>
                      <small> <?php echo form_error("re-pass");?></small>
                  <?php }?>
                </div>
                <!-- /.card-body -->
